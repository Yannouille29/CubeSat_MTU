...
//-----------------------verrify the bme sensor----------------------------------

  if (bme.begin(0x76)) {
    bmePresent = 1;
  } else {
    Serial.println("Could not find a valid BME280 sensor, check wiring!");          //Serial1 refer to the serial port and UART communocation with the pi 0
    bmePresent = 0;
  }
...
//-----------------------------------------------------------------------------------
//--------------------Stat communication on the UART port----------------------------
//-----------------------------------------------------------------------------------
